...
public class C02_RelativeLocarts {
    public static void main(String[] args) {
        ...
        //Sayfadaki "Berlin" web elementini relative locator kullanarak tiklayalim.
        WebElement NYCWE = driver.findElement(By.id("pid3_thumb"));
        WebElement BayAreaWE = driver.findElement(By.id("pid8_price"));
